            ...
            children: [
                            ...
                            Expanded(
                              child: Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'SUPPORT_Container_ok62svxq_ON_TAP');
                                    logFirebaseEvent('Container_navigate_to');

                                    context
                                        .pushNamed(AskAiPageWidget.routeName);
                                  },
                                  child: Container(
                                    width: 120.0,
                            ...
                            Expanded(
                              child: Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'SUPPORT_Container_uejw2d2d_ON_TAP');
                                    logFirebaseEvent('Container_navigate_to');

                                    context
                                        .pushNamed(EmailPageWidget.routeName);
                                  },
                                  child: Container(
                                    width: 120.0,
                                    constraints: BoxConstraints(
                            ...
                            Expanded(
                              child: Padding(
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    logFirebaseEvent(
                                        'SUPPORT_Container_vnvd6r4b_ON_TAP');
                                    logFirebaseEvent('Container_navigate_to');

                                    context.pushNamed(
                                        SearchFaqPageWidget.routeName);
                                  },
                                  child: Container(
                                    width: 120.0,
                                    constraints: BoxConstraints(
                                ...
                                children: [
                                  ...
                                  Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        0.0, 4.0, 0.0, 0.0),
                                    child: Text(
                                      'You can create a new meal plan by navigating to the home screen, and selecting create!',
                                      style: FlutterFlowTheme.of(context)
                                          .labelMedium
                                          .override(
                                            fontFamily: 'Inter',
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    'How do I edit my survey Results?',
                                    style: FlutterFlowTheme.of(context)
                                        .bodyLarge
                                        .override(
                                          fontFamily: 'Inter',
                                  ...
                                  Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        0.0, 4.0, 0.0, 0.0),
                                    child: Text(
                                      'To edit your survey results, navigate to the home page and go to profile......',
                                      style: FlutterFlowTheme.of(context)
                                          .labelMedium
                                          .override(
                                            fontFamily: 'Inter',
                          ...
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  Text(
                                    'How many Meal Plans can I save?',
                                    style: FlutterFlowTheme.of(context)
                                        .bodyLarge
                                        .override(
                                          fontFamily: 'Inter',
              ...
              Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    logFirebaseEvent('SUPPORT_CREATE_TICKET_BTN_ON_TAP');
              ...
              Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    logFirebaseEvent('SUPPORT_PAGE_PAGE_CHAT_NOW_BTN_ON_TAP');
                    logFirebaseEvent('Button_navigate_to');

                    context.pushNamed(AskAiPageWidget.routeName);
                  },
                  text: 'Chat Now',
                  icon: Icon(
