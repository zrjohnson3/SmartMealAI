...
class _CreateAccountTest1WidgetState extends State<CreateAccountTest1Widget>
  ...
  void initState() {
    ...
    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'CreateAccount_Test1'});
        ...
        body: Column(
          ...
          children: [
                      ...
                      children: [
                        Padding(
                          ...
                          child: Container(
                            width: double.infinity,
                            child: TextFormField(
                              key: ValueKey('emailAddress_Create_2cvo'),
                              controller:
                        ...
                        Padding(
                          ...
                          child: Container(
                            width: double.infinity,
                            child: TextFormField(
                              key: ValueKey('password_Create_lung'),
                        ...
                        Align(
                          ...
                          child: Padding(
                            ...
                            child: FFButtonWidget(
                              key: ValueKey('Get_Started_Button_ji47'),
                              onPressed: () async {
                                logFirebaseEvent(
                                    'CREATE_ACCOUNT_TEST1_Get_Started_Button_');
                                logFirebaseEvent(
                                    'Get_Started_Button_validate_form');
                                if (_model.formKey.currentState == null ||
                                    !_model.formKey.currentState!.validate()) {
                                  return;
                                }
                                logFirebaseEvent('Get_Started_Button_auth');
                                ...
                                logFirebaseEvent(
                                    'Get_Started_Button_navigate_to');
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: () async {
                                          logFirebaseEvent(
                                              'CREATE_ACCOUNT_TEST1_GoogleButton_ON_TAP');
            ...
            InkWell(
              ...
              onTap: () async {
                logFirebaseEvent('CREATE_ACCOUNT_TEST1_SignInButton_ON_TAP');
