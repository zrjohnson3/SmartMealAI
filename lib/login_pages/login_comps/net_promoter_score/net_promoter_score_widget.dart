...
/// Net Promoter Score pop up component that will appear after 5 logins and
/// have a short survey on user satisfaction
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              ...
                              await currentUserReference!.update({
                                ...mapToFirestore(
                                  {
                                    'net_promoter_score': FieldValue.arrayUnion(
                                        [_model.sliderValue]),
